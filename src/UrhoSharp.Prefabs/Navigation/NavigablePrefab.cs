...
{
    public class NavigablePrefab: AbstractComponentPrefab<Navigable>, IPrefab
    {
        private static  bool RecursiveDefaultValue = true;
        ...
        {
            _recursive = RecursiveDefaultValue;
        ...
        public bool RecursiveHasValue {get { return !PrefabUtils.AreEqual(ref _recursive, ref RecursiveDefaultValue); } }
        ...
        public override Navigable Create()
        {
            ...
            if(RecursiveHasValue)
                result.Recursive = _recursive;
            if(EnabledHasValue)
