...
{
    public class NavigationMeshPrefab: AbstractComponentPrefab<NavigationMesh>, IPrefab
    {
        private static  int TileSizeDefaultValue = 128;
        ...
        private static  NavmeshPartitionType PartitionTypeDefaultValue = NavmeshPartitionType.Watershed;
