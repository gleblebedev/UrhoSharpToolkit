...
{
    public class TerrainPatchPrefab: AbstractComponentPrefab<TerrainPatch>, IPrefab
    {
        private static  Terrain OwnerDefaultValue = null;
        private static  IntVector2 CoordinatesDefaultValue = new IntVector2(0, 0);
        ...
        {
            _owner = OwnerDefaultValue;
            _coordinates = CoordinatesDefaultValue;
        ...
        public Terrain Owner {get { return _owner;} set { _owner=value; } }
        public bool OwnerHasValue {get { return !PrefabUtils.AreEqual(ref _owner, ref OwnerDefaultValue); } }
        public IntVector2 Coordinates {get { return _coordinates;} set { _coordinates=value; } }
        public bool CoordinatesHasValue {get { return !PrefabUtils.AreEqual(ref _coordinates, ref CoordinatesDefaultValue); } }
        ...
        public override TerrainPatch Create()
        {
            ...
            if(OwnerHasValue)
                result.Owner = _owner;
            if(CoordinatesHasValue)
                result.Coordinates = _coordinates;
