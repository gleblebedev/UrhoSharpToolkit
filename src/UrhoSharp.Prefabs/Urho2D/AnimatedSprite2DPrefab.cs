...
{
    public class AnimatedSprite2DPrefab: AbstractComponentPrefab<AnimatedSprite2D>, IPrefab
    {
        private static  AnimationSet2D AnimationSetDefaultValue = null;
        private static  String EntityDefaultValue = "";
        private static  LoopMode2D LoopModeDefaultValue = LoopMode2D.Default;
        ...
        private AnimationSet2D _animationSet;
        private String _entity;
        private LoopMode2D _loopMode;
        ...
        {
            _animationSet = AnimationSetDefaultValue;
            _entity = EntityDefaultValue;
            _loopMode = LoopModeDefaultValue;
        ...
        {
            _animationSet = val.AnimationSet;
            _entity = val.Entity;
            _loopMode = val.LoopMode;
            _speed = val.Speed;
            _sprite = val.Sprite;
        ...
        public AnimationSet2D AnimationSet {get { return _animationSet;} set { _animationSet=value; } }
        public bool AnimationSetHasValue {get { return !PrefabUtils.AreEqual(ref _animationSet, ref AnimationSetDefaultValue); } }
        public String Entity {get { return _entity;} set { _entity=value; } }
        public bool EntityHasValue {get { return !PrefabUtils.AreEqual(ref _entity, ref EntityDefaultValue); } }
        public LoopMode2D LoopMode {get { return _loopMode;} set { _loopMode=value; } }
        public bool LoopModeHasValue {get { return !PrefabUtils.AreEqual(ref _loopMode, ref LoopModeDefaultValue); } }
        ...
        public override AnimatedSprite2D Create()
        {
            ...
            if(AnimationSetHasValue)
                result.AnimationSet = _animationSet;
            if(EntityHasValue)
                result.Entity = _entity;
            if(LoopModeHasValue)
                result.LoopMode = _loopMode;
            if(SpeedHasValue)
                result.Speed = _speed;
            if(SpriteHasValue)
