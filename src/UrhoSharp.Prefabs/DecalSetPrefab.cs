...
{
    public class DecalSetPrefab: AbstractComponentPrefab<DecalSet>, IPrefab
    {
        private static  Material MaterialDefaultValue = null;
        private static  uint MaxVerticesDefaultValue = 512;
        private static  uint MaxIndicesDefaultValue = 1024;
        private static  bool OptimizeBufferSizeDefaultValue = false;
        ...
        private bool _optimizeBufferSize;
        ...
        public DecalSetPrefab()
        {
            ...
            _maxVertices = MaxVerticesDefaultValue;
            _maxIndices = MaxIndicesDefaultValue;
            _optimizeBufferSize = OptimizeBufferSizeDefaultValue;
        ...
        public DecalSetPrefab(DecalSet val)
        {
            ...
            _maxVertices = val.MaxVertices;
            _maxIndices = val.MaxIndices;
            _optimizeBufferSize = val.OptimizeBufferSize;
        ...
        public uint MaxVertices {get { return _maxVertices;} set { _maxVertices=value; } }
        public bool MaxVerticesHasValue {get { return !PrefabUtils.AreEqual(ref _maxVertices, ref MaxVerticesDefaultValue); } }
        public uint MaxIndices {get { return _maxIndices;} set { _maxIndices=value; } }
        public bool MaxIndicesHasValue {get { return !PrefabUtils.AreEqual(ref _maxIndices, ref MaxIndicesDefaultValue); } }
        public bool OptimizeBufferSize {get { return _optimizeBufferSize;} set { _optimizeBufferSize=value; } }
        public bool OptimizeBufferSizeHasValue {get { return !PrefabUtils.AreEqual(ref _optimizeBufferSize, ref OptimizeBufferSizeDefaultValue); } }
        ...
        public override DecalSet Create()
        {
            ...
            if(MaxVerticesHasValue)
                result.MaxVertices = _maxVertices;
            if(MaxIndicesHasValue)
                result.MaxIndices = _maxIndices;
            if(OptimizeBufferSizeHasValue)
                result.OptimizeBufferSize = _optimizeBufferSize;
